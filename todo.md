...
## Stock Usage History Display (May 20)
- [x] Add Stock Usage History section to Purchase Order dialog
- [x] Display available quantity at top
- [x] List all usage records (Job No and Old Stock) with quantities
- [x] Show current remaining quantity at bottom
- [x] Optimize for mobile and desktop views
- [x] Add visual hierarchy and proper spacing
- [x] Write unit tests for stock history display (6 tests, all passing)
