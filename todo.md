...
## Approval Center Display Text Updates (May 26)
- [x] Change display text "Request" → "Purchase Order" in Approval Center
- [x] Change display text "Action History" → "Stock Usage Balance History"
- [x] Update only user-visible labels and UI text
