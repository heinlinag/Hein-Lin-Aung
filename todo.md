...
## Desktop Profile Panel (May 22)
- [x] Convert profile dropdown to persistent left-side dashboard panel on desktop
- [x] Show profile info, quick links, and logout in sidebar on desktop
- [x] Keep mobile view unchanged (dropdown behavior)
- [x] Add responsive breakpoint (lg:) to show/hide panel
- [x] Style panel to match dashboard aesthetic with gradient background
- [x] Add unit tests for desktop profile panel (59 tests, all passing)
