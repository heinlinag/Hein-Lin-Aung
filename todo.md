...
## Login Page & Branding Update (May 20)
- [x] Update login page version display to v6c89c239
- [x] Update Documentation page version to v6c89c239
- [x] Update GeoRestricted component version footer
- [x] Ensure all auth pages match current version branding
- [x] Test login flow on mobile and desktop
