      ...
      <main className="container lg:max-w-none lg:px-8 py-4">
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            placeholder="Search by Order ID, Job No, Flute, BQ..."
        ...
        {usageHistory.isLoading ? (
          ...
          <>
            ...
            <div className="md:hidden space-y-3">
              {filtered.map(entry => (
                <div key={entry.id} className="bg-white border border-border rounded-xl p-4 shadow-sm">
                  <div className="flex items-start justify-between gap-2 mb-3">
                    ...
                    <span className="font-bold text-primary text-lg">{entry.usedQty} pcs</span>
                  </div>
